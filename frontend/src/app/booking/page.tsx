    ...
    return (
        <main className="mt-8">
            <div className="bg-white  min-h-full w-auto rounded-3xl m-8 px-16 py-12 md:px-15 md:mx-20 relative ">
                ...
                {
                    !hasBooked && !buttonClicked ? <button className="block m-auto rounded-md px-8 py-2 font-semibold text-white shadow-sm bg-[#252645] bg-gradient-to-r hover:from-[#252645] hover:to-[#5C5EAB]" onClick={book}>Book This</button> :
                        <Link href={'/mybooking'}><button className="block m-auto rounded-md px-8 py-2 font-semibold text-white shadow-sm bg-[#252645] bg-gradient-to-r hover:from-[#252645] hover:to-[#5C5EAB]">View My Booking</button></Link>
                }
            </div>
        </main>
    );
